...
const crawler = async () => {
  ...
  await page.goto(
    `https://www.coupang.com/np/search?component=&q=%ED%81%AC%EB%A6%B4%EC%98%A4%EC%9D%BC+%EB%8B%A4%EC%9D%B4%EC%96%B4%ED%8A%B8&channel=user`
  );
...
const scraping = async (page) => {
  ...
  await page.waitForFunction(() => {
    const images = document.querySelectorAll(
      "li.search-product > a.search-product-link > dl > dt > img"
    );
  ...
  const productName_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dd > div > div.name"
  );
  const originalPrice_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dd > div > div.price-area > div > div.price > span.price-info > del "
  );
  const discountedPrice_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dd > div > div.price-area > div > div.price > em > strong"
  );
  const rating_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dd > div > div.other-info > div > span.star > em"
  );
  const reviewCount_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dd > div > div.other-info > div > span.rating-total-count"
  );
  const productImage_Elements = await page.$$(
    "li.search-product > a.search-product-link > dl > dt > img"
  );
  const productLink_Elements = await page.$$(
    "li.search-product > a.search-product-link"
  );
